...
class FXConverter(object):
    ...
    def _server_init(self):
        ...
        self._server.bind((self._config.get('Listener', 'Host'),
    ...
    def _process_request(self, downstream_cli, msg):
        ...
        self._logger.info('Request result for {} with rate {}: {}'.format(
            msg[8:], rate, result))
        return result
        ...
        while True:
            ...
            if msg == 'Stop':
                ...
                try:
                    ...
                    self._logger.info('Propagating query {} to {}'.format(
                        msg, downstream_addr))
    ...
    def loop(self):
        ...
        downstream_addr = (self._config.get('Downstream', 'Host'),
                          int(self._config.get('Downstream', 'Port')))
        self._logger.info('Connected to downstream: {}:{}'.format(
