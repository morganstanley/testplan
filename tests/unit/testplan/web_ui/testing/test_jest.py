...
def is_npm_installed():
    """
    Checks if NPM has been installed.
    """
...
def tp_ui_installed():
    """
    Checks if the Testplan UI dependencies have been installed.
    """
...
@pytest.mark.skipif(
    not (is_npm_installed() and tp_ui_installed()),
...
@pytest.mark.skipif(
    not (is_npm_installed() and tp_ui_installed()),
    reason="requires NPM & testplan UI have been installed.",
)
def test_eslint():
    """
