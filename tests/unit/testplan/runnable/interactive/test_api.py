...
class TestReport:
    ...
    def test_get(self, api_env):
        ...
        assert json_rsp["runtime_status"] == report.RuntimeStatus.READY.value
    ...
    def test_put(self, api_env):
        ...
        json_report = ihandler.report.shallow_serialize()
        json_report["runtime_status"] = report.RuntimeStatus.RUNNING.value
        rsp = client.put("/api/v1/interactive/report", json=json_report)
        assert rsp.status_code == 200
        rsp_json = rsp.get_json()
        assert rsp_json["runtime_status"] == report.RuntimeStatus.WAITING.value
    ...
    def test_put_reset(self, api_env):
        ...
        json_report = ihandler.report.shallow_serialize()
        json_report["runtime_status"] = report.RuntimeStatus.RESETTING.value
        rsp = client.put("/api/v1/interactive/report", json=json_report)
        assert rsp.status_code == 200
        rsp_json = rsp.get_json()
        assert rsp_json["runtime_status"] == report.RuntimeStatus.WAITING.value
...
class TestSingleTest:
    ...
    def test_put(self, api_env):
        ...
        json_test = ihandler.report["MTest1"].shallow_serialize()
        json_test["runtime_status"] = report.RuntimeStatus.RUNNING.value
        rsp = client.put(
            "/api/v1/interactive/report/tests/MTest1", json=json_test
        )
        assert rsp.status_code == 200
        json_rsp = rsp.get_json()
        assert json_rsp["runtime_status"] == report.RuntimeStatus.WAITING.value
    ...
    def test_put_reset(self, api_env):
        ...
        json_test = ihandler.report["MTest1"].shallow_serialize()
        json_test["runtime_status"] = report.RuntimeStatus.RESETTING.value
        rsp = client.put(
            "/api/v1/interactive/report/tests/MTest1", json=json_test
        )
        assert rsp.status_code == 200
...
class TestSingleSuite:
    ...
    def test_put(self, api_env):
        ...
        suite_json = ihandler.report["MTest1"]["MT1Suite1"].shallow_serialize()
        suite_json["runtime_status"] = report.RuntimeStatus.RUNNING.value
        rsp = client.put(
            "/api/v1/interactive/report/tests/MTest1/suites/MT1Suite1",
            json=suite_json,
        )
...
class TestSingleTestcase:
    ...
    def test_put(self, api_env, testcase_uid):
        ...
        testcase_json["runtime_status"] = report.RuntimeStatus.RUNNING.value
