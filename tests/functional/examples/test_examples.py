...
# This file is under tests/functional/examples, so the root of this repo
# should be 3 levels up.
ROOT_DIR = os.path.abspath(os.path.join(
    FILE_DIR, *(os.pardir for _ in range(3))))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for root, _, files in os.walk(
            EXAMPLES_ROOT, followlinks=True)
