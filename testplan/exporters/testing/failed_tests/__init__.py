                ...
                for testsuite in multitest:
                    if testsuite.failed:
                        ...
                        if (
                            ...
                            failed_tests += (
                                f"{multitest.name}:{testsuite.name}\n"
                            )
                            continue
                        for testcase in testsuite:
                            ...
                            if isinstance(
                                ...
                                failed_tests += f"{multitest.name}:{testsuite.name}:{testcase.name}\n"
                failed_tests_file.write(failed_tests)
