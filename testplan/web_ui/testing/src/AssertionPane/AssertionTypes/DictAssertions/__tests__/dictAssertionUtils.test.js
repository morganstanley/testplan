...
describe("dictAssertionUtils", () => {
  it("sortFlattenedJSON used to sort the data of dict-like assertions", () => {
    ...
    expect(sortFlattenedJSON(flattenedDict, 0, false, false)).toEqual(
      expectedByChar
    );
    expect(sortFlattenedJSON(flattenedDict, 0, true, false)).toEqual(
      expectedByCharReverse
    );
    expect(sortFlattenedJSON(flattenedDict, 0, false, true)).toEqual(
      expectedByStatus
    );
  });
});
