...
class TCPTestsuite(object):
    ...
    def send_and_receive_msg(self, env, result):
        ...
        result.equal(env.client1.receive_text(size=resp_size),
                     response, 'Client1 received')
        ...
        result.equal(env.client2.receive_text(size=resp_size),
                     response, 'Client2 received')
